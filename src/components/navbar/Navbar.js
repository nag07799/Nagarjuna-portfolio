...
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaRobot } from "react-icons/fa";
  ...
  return (
    <div className="w-full h-24 sticky top-0 z-50 bg-bodyColor mx-auto flex justify-between items-center font-titleFont border-b-[1px] border-b-gray-600">
      ...
      <div className="flex items-center gap-4">
        ...
        <ThemeToggle className="hidden mdl:flex mdl:flex-row mdl:items-center mdl:gap-3 ml-4" />
        <button
        ...
        >
          ...
          <span className="text-sm font-medium">Ask Nagarjuna</span>
        </button>
        <span
